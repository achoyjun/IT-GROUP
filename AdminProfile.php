        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="page-header">
              <h1 id="tables">Pending Room Reservation<span id="PRRTB" class="badge badge-danger badge-pill"></span></h1>
          ...
          <!--Jquery for getting the content of messages from the link-->
           <script>
             $(document).ready( function()
              {
               setInterval(function() {
                  $('#PRRTB').load('CountPendingRoomRes.php');
                },1000);
              });
           </script>
            ...
            <div class="bs-component">
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Reason for Reserving</th>
              ...
              <?php include('PendingRoomResTB.php'); ?>
              </table> 
            </div>
          </div>
        </div>
