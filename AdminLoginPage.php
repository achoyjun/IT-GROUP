            ...
            <form method="post" action="AdminLoginProcess.php">  
              <div class="form-group">
                <div class="col-lg-12"><br>
                  <input type="text" class="form-control text-center" id="txtIDNum" name="IDNum" placeholder="ID Number" required><br>
             
                  <!--Input box for Password-->
                  <input type="password" class="form-control text-center" id="txtPword" name="Pword" placeholder="Password" required><br> 
                    <!--Button for Submit the form-->
                    <input type="submit" name="LoginSubmit" id="btnSub" class="btn btn-info btn-block" value="Login"><br> 
                     
     <!--Button-->   
                <a href="SignUpFormAdmin.php" class="btn btn-success btn-lg btn-block btn-xs" value="SignUp for Admin">Sign-Up for Admin</a>
                  <br>
                <!--Back Button-->
